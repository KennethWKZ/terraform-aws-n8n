...
locals {
  ...
  db_min_capacity          = get_env("N8N_DB_MIN_CAPACITY", "1")
  db_max_capacity          = get_env("N8N_DB_MAX_CAPACITY", "16")
  db_instance_count        = get_env("N8N_DB_INSTANCE_COUNT", "1")
  db_deletion_protection   = get_env("N8N_DB_DELETION_PROTECTION", "true")
  db_skip_final_snapshot   = get_env("N8N_DB_SKIP_FINAL_SNAPSHOT", "false")
